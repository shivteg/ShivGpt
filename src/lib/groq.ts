...
export const TEXT_MODELS: GroqModelInfo[] = [
  ...
  },
  {
    ...
    description: 'Meta vision-language model trained for high-speed image analysis & visual QA.',
    contextWindow: 128000,
  ...
  },
  {
    ...
    description: 'Meta flagship high-capacity multimodal model for advanced visual reasoning.',
    contextWindow: 128000,
